              ...
              <article className="group overflow-hidden rounded-2xl border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900 shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02]">
                ...
                <div className="p-5 space-y-3">
                  <div className="space-y-2">
                    <h2 className="text-lg font-bold leading-tight group-hover:text-framer-blue transition-colors">
                      {shot.title}
                    </h2>
                    {shot.caption && (
                  ...
                  <div className="flex items-center justify-between gap-3 text-sm">
                    ...
                    {/* Image count */}
                    {images.length > 1 && (
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-framer-blue/10 text-framer-blue rounded-xl text-xs font-medium">
                        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
