...
<div className="overflow-x-auto my-6">
  <table className="min-w-full border-collapse">
    <thead>
      <tr className="bg-gradient-to-r from-framer-blue/20 to-framer-blue-light/20 border-b border-white/20">
        <th className="px-6 py-3 text-left text-sm font-semibold text-white">Metric</th>
        <th className="px-6 py-3 text-left text-sm font-semibold text-white">Manual (Paper)</th>
        <th className="px-6 py-3 text-left text-sm font-semibold text-white">Chatbot</th>
        <th className="px-6 py-3 text-left text-sm font-semibold text-white">Improvement</th>
      </tr>
    </thead>
    <tbody className="divide-y divide-white/10">
      <tr className="hover:bg-white/5 transition-colors">
        <td className="px-6 py-4 text-sm text-text-secondary">Avg anamnesis time</td>
        <td className="px-6 py-4 text-sm text-text-secondary">12-15 min</td>
        <td className="px-6 py-4 text-sm text-text-secondary">8-9 min</td>
        <td className="px-6 py-4 text-sm text-emerald-400 font-semibold">~30% faster</td>
      </tr>
      <tr className="hover:bg-white/5 transition-colors">
        <td className="px-6 py-4 text-sm text-text-secondary">Data completeness</td>
        <td className="px-6 py-4 text-sm text-text-secondary">78% fields filled</td>
        <td className="px-6 py-4 text-sm text-text-secondary">95% fields filled</td>
        <td className="px-6 py-4 text-sm text-emerald-400 font-semibold">+17%</td>
      </tr>
      <tr className="hover:bg-white/5 transition-colors">
        <td className="px-6 py-4 text-sm text-text-secondary">Errors (missing/wrong)</td>
        <td className="px-6 py-4 text-sm text-text-secondary">12%</td>
        <td className="px-6 py-4 text-sm text-text-secondary">4%</td>
        <td className="px-6 py-4 text-sm text-emerald-400 font-semibold">-67% errors</td>
      </tr>
    </tbody>
  </table>
</div>
...
<div className="overflow-x-auto my-6">
  <table className="min-w-full border-collapse">
    <thead>
      <tr className="bg-gradient-to-r from-framer-blue/20 to-framer-blue-light/20 border-b border-white/20">
        <th className="px-6 py-3 text-left text-sm font-semibold text-white">Metric</th>
        <th className="px-6 py-3 text-left text-sm font-semibold text-white">Value</th>
      </tr>
    </thead>
    <tbody className="divide-y divide-white/10">
      <tr className="hover:bg-white/5 transition-colors">
        <td className="px-6 py-4 text-sm text-text-secondary">API latency (p50)</td>
        <td className="px-6 py-4 text-sm text-text-secondary">120ms</td>
      </tr>
      <tr className="hover:bg-white/5 transition-colors">
        <td className="px-6 py-4 text-sm text-text-secondary">API latency (p95)</td>
        <td className="px-6 py-4 text-sm text-text-secondary">280ms</td>
      </tr>
      <tr className="hover:bg-white/5 transition-colors">
        <td className="px-6 py-4 text-sm text-text-secondary">API latency (p99)</td>
        <td className="px-6 py-4 text-sm text-text-secondary">450ms</td>
      </tr>
      <tr className="hover:bg-white/5 transition-colors">
        <td className="px-6 py-4 text-sm text-text-secondary">Frontend page load</td>
        <td className="px-6 py-4 text-sm text-text-secondary">1.2s (Vercel CDN)</td>
      </tr>
      <tr className="hover:bg-white/5 transition-colors">
        <td className="px-6 py-4 text-sm text-text-secondary">Backend uptime</td>
        <td className="px-6 py-4 text-sm text-text-secondary">99.8%</td>
      </tr>
      <tr className="hover:bg-white/5 transition-colors">
        <td className="px-6 py-4 text-sm text-text-secondary">Session duration (avg)</td>
        <td className="px-6 py-4 text-sm text-text-secondary">8.5 minutes</td>
      </tr>
      <tr className="hover:bg-white/5 transition-colors">
        <td className="px-6 py-4 text-sm text-text-secondary">Messages per session (avg)</td>
        <td className="px-6 py-4 text-sm text-text-secondary">18 messages</td>
      </tr>
    </tbody>
  </table>
</div>
...
4. **Voice Input**: Integrate Web Speech API for hands-free anamnesis.

5. **EMR System Integration**: Export to hospital systems (HL7 FHIR standard).

6. **Symptom-Disease Inference**: Suggest probable diagnoses based on symptom patterns.

7. **Publish Dataset**: Release 14K-sample dataset to research community.
