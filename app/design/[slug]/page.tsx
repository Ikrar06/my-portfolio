          ...
          <div className="space-y-4 sm:space-y-6 relative">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-xs sm:text-sm">
                {/* Category Badge */}
                {category && (
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-blue-100 text-blue-800 rounded-xl sm:rounded-xl text-[10px] sm:text-sm font-medium dark:bg-blue-900 dark:text-blue-200">
                    {category}
                  </span>
                )}
                ...
                {/* Work Type Badges */}
                {eventWork ? (
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-indigo-100 text-indigo-800 rounded-xl sm:rounded-xl text-[10px] sm:text-sm font-medium dark:bg-indigo-900 dark:text-indigo-200">
                    Event Work
                  </span>
                ) : competitionWork ? (
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-orange-100 text-orange-800 rounded-xl sm:rounded-xl text-[10px] sm:text-sm font-medium dark:bg-orange-900 dark:text-orange-200">
                    Competition
                  </span>
                ) : organizationWork ? (
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-purple-100 text-purple-800 rounded-xl sm:rounded-xl text-[10px] sm:text-sm font-medium dark:bg-purple-900 dark:text-purple-200">
                    Organization Work
                  </span>
                ) : (
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-emerald-100 text-emerald-800 rounded-xl sm:rounded-xl text-[10px] sm:text-sm font-medium dark:bg-emerald-900 dark:text-emerald-200">
                    Design
                  </span>
                )}
                ...
                {eventWork && eventName && (
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-violet-100 text-violet-800 rounded-xl sm:rounded-xl text-[10px] sm:text-sm font-medium dark:bg-violet-900 dark:text-violet-200">
                    {eventName}
                  </span>
                )}

                {eventWork && eventType && (
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-cyan-100 text-cyan-800 rounded-xl sm:rounded-xl text-[10px] sm:text-sm font-medium dark:bg-cyan-900 dark:text-cyan-200">
                    {eventType}
                  </span>
                )}

                {competitionWork && competitionName && (
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-amber-100 text-amber-800 rounded-xl sm:rounded-xl text-[10px] sm:text-sm font-medium dark:bg-amber-900 dark:text-amber-200">
                    {competitionName}
                  </span>
                )}

                {competitionWork && competitionCategory && (
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-yellow-100 text-yellow-800 rounded-xl sm:rounded-xl text-[10px] sm:text-sm font-medium dark:bg-yellow-900 dark:text-yellow-200">
                    {competitionCategory}
                  </span>
                )}

                {/* Time Badges */}
                <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-neutral-100 text-neutral-700 rounded-xl sm:rounded-xl text-[10px] sm:text-sm font-medium dark:bg-neutral-800 dark:text-neutral-300">
                  {year}
                </span>
